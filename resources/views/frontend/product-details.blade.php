							...
							<div class="product">
								...
								<div class="product-details-area">
                                    ...
                                    @endif
									 ...
									 @if ($same_pro->product_quantity == 0 )
                                
                               
									<div class="product-actions">
										<button  data-id="{{$same_pro->id}}" data-name="{{$same_pro->product_name}}" data-price="{{$same_pro->selling_price}}" data-image="{{$same_pro->default_image}}" data-quantity="{{$same_pro->product_quantity}}" class="btn btn-danger {{$same_pro->id}}">Out of Stock</button>
									...
									@else
										<div class="product-actions">
										<button  data-id="{{$same_pro->id}}" data-name="{{$same_pro->product_name}}" data-price="{{$same_pro->selling_price}}" data-image="{{$same_pro->default_image}}" data-quantity="{{$same_pro->product_quantity}}" class="btn btn-primary addcart addcart{{$same_pro->id}}">Add to Bag</button>
										{{-- <a href="#" class="addtocart related-btn-cart" title="Add to Bag" rel_id="3018" price="40" rel_token="uNBH1fYLF50pskZAVuzEknqL9QVyejIUH5Bu4PIu" rel_qty="1">
											<i class="fa fa-shopping-cart"></i>
											<span>Add to Bag</span>
										</a> --}}
						...
						<div>
							<div class="product product-sm" style="max-width: 350px;">
								...
								<div class="product-details-area">
									...
									@if ($fproduct->product_quantity == 0)
									
									<div class="product-actions">
										<button  data-id="{{$fproduct->id}}" data-name="{{$fproduct->product_name}}" data-price="{{$fproduct->selling_price}}" data-image="{{$fproduct->default_image}}" class="btn btn-danger product_cart_button {{$fproduct->id}}">Out of Stock</button>
