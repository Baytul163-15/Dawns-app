                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            @guest
                                            <input type="text" name="billing_name" value="" title="User Name" class="form-control" required>
                                            @else
                                            <input type="text" name="billing_name" value="{{ Auth::user()->name }}" title="User Name" class="form-control" required>
                                            @endguest
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            @guest
                                            <input type="text" name="billing_mobile" value="" title="Mobile" class="form-control mobile_number" placeholder="880" required>
                                            @else
                                            <input type="text" name="billing_mobile" value="" title="Mobile" class="form-control mobile_number" placeholder="880" required>
                                            @endguest
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group wide">
                                            ...
                                            @guest
                                            <input id="billing" type="text" class="form-control" name="billing_address" value="" placeholder="Apartment, house, road, area etc." required>
                                            @else
                                            <input id="billing" type="text" class="form-control" name="billing_address" value="{{ Auth::user()->address }}" placeholder="Apartment, house, road, area etc." required>
                                            @endguest
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12 col-md-12">
                                        <div class="form-group wide" >
                                            ...
                                            @else
                                            <input type="text" name="billing_email" value="{{ Auth::user()->email }}" title="Email Address" class="form-control email_address" required  />
                                            @endguest
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm m-0" name="billing_district" id="division_id" class="required" required>
...
<script>
    ...
    function myFunction(e) {
        ...
        if (delivery_type == 2) {
            ...
            document.getElementById("delivery_charge").value = 60;
            document.getElementById("delivery_charge_span").innerHTML="60";
        }
    }
</script>
@endsection