                        ...
                        <div class="product">
                            ...
                            <div class="product-details-area">
                                ...
                                <div class="product-actions">
                                    <button  data-id="{{$product->id}}" data-name="{{$product->product_name}}" data-price="{{$product->discount_price}}" data-image="{{$product->default_image}}" data-quantity="{{$product->product_quantity}}" class="btn btn-danger product_cart_button {{$product->id}}">Out of Stock</button>
                                </div>
                                
                                @else
                                <div class="product-actions">
                                    <button  data-id="{{$product->id}}" data-name="{{$product->product_name}}" data-price="{{$product->discount_price}}" data-image="{{$product->default_image}}" data-quantity="{{$product->product_quantity}}" class="product_cart_button addcart addcart{{$product->id}}">Add to Bag</button>
                                </div>
                                @endif
                    ...
                    <div class="owl-carousel owl-theme manual new-products-carousel">
                        ...
                        <div class="product">
                            ...
                            <div class="product-details-area">
                                ...
                                @if ($scproduct->product_quantity == 0 )
                                
                                <div class="product-actions">
                                    <button  data-id="{{$scproduct->id}}" data-name="{{$scproduct->product_name}}" data-price="{{$scproduct->discount_price}}" data-image="{{$scproduct->default_image}}" data-quantity="{{$scproduct->product_quantity}}" class="btn btn-danger product_cart_button {{$scproduct->id}}">Out of Stock</button>
                                </div>
                                
                                @else
                                <div class="product-actions">
                                    <button  data-id="{{$scproduct->id}}" data-name="{{$scproduct->product_name}}" data-price="{{$scproduct->discount_price}}" data-image="{{$scproduct->default_image}}" data-quantity="{{$scproduct->product_quantity}}" class="product_cart_button addcart addcart{{$scproduct->id}}">Add to Bag</button>
                                </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="owl-carousel owl-theme manual new-products-carousel">
                        ...
                        <div class="product">
                            ...
                            <div class="product-details-area">
                                ...
                                @if ($hproduct->product_quantity == 0 )
                                
                                <div class="product-actions">
                                    <button  data-id="{{$hproduct->id}}" data-name="{{$hproduct->product_name}}" data-price="{{$hproduct->discount_price}}" data-image="{{$hproduct->default_image}}" data-quantity="{{$hproduct->product_quantity}}" class="btn btn-danger product_cart_button {{$hproduct->id}}">Out of Stock</button>
                                </div>
                                
                                @else
                                <div class="product-actions">
                                    <button  data-id="{{$hproduct->id}}" data-name="{{$hproduct->product_name}}" data-price="{{$hproduct->discount_price}}" data-image="{{$hproduct->default_image}}" data-quantity="{{$hproduct->product_quantity}}" class="product_cart_button addcart addcart{{$hproduct->id}}">Add to Bag</button>
                                </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="owl-carousel owl-theme manual new-products-carousel">
                        ...
                        <div class="product">
                            ...
                            <div class="product-details-area">
                                ...
                                @if ($product->fsproduct_quantity == 0 )
                                
                                <div class="product-actions">
                                    <button  data-id="{{$fsproduct->id}}" data-name="{{$fsproduct->product_name}}" data-price="{{$fsproduct->discount_price}}" data-image="{{$fsproduct->default_image}}" data-quantity="{{$fsproduct->product_quantity}}" class="btn btn-danger product_cart_button {{$fsproduct->id}}">Out of Stock</button>
                                </div>
                                
                                @else
                                <div class="product-actions">
                                    <button  data-id="{{$fsproduct->id}}" data-name="{{$fsproduct->product_name}}" data-price="{{$fsproduct->discount_price}}" data-image="{{$fsproduct->default_image}}" data-quantity="{{$fsproduct->product_quantity}}" class="product_cart_button addcart addcart{{$fsproduct->id}}">Add to Bag</button>
                                </div>
                                @endif
                            </div>
                        </div>
