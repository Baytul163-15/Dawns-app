							...
							<div class="product product-sm">
								...
								<div class="product-details-area">
									...
									<div class="product-actions">
										<button  data-id="{{$prow->id}}" data-name="{{$prow->product_name}}" data-price="{{$prow->selling_price}}" data-image="{{$prow->default_image}}" class="btn btn-danger{{$prow->id}}">Out of Stock</button>
									</div>
									@else
									<div class="product-actions">
